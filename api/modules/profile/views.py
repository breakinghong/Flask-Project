...
from api.utils.common import auth_identify, check_file_type
from api.utils.constants import QINIU_DOMIN_PREFIX
from api.utils.fastdfs.fdfs import FastDFSStorage
from api.utils.response_utils import error, HttpCode, success
from config.settings import BASE_DIR


@profile_blu.route('/user', methods=['GET', 'POST'])
@auth_identify
def user():
...
@profile_blu.route('/pic/<int:user_id>', methods=['POST'])
def pic(user_id):
    """
    上传图片   用户头像
