...
class VideoInfo(db.Model):
    ...
    imdb_id = db.Column(db.String(16), unique=True)  # 标题
    movie_id = db.Column(db.String(16))  # 标题
    tmdb_id = db.Column(db.String(16))  # 标题
    ...
    writers = db.Column(db.String(255))  # 摘要描述
    stars = db.Column(db.String(255))  # 明星
    storyline = db.Column(db.String(255))  # 明星
